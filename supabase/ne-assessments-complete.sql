-- =============================================================================
-- NE ASSESSMENTS: run this ENTIRE file once in Supabase SQL Editor
-- No Netlify deploy needed — this updates the database only.
-- After success: hard-refresh app, sign out, sign in as PM → New England
-- =============================================================================
...
-- Name match report (all 23 should have a tech_id; NULL = import skipped that person)
SELECT i.tech_name, app_match_technician_id(i.tech_name) AS matched_tech_id
FROM (SELECT DISTINCT tech_name FROM _ne_import) i
